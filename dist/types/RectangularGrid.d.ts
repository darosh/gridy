...
export declare class RectangularGrid implements IGrid<RectangularTile | Rectangular8Tile> {
    ...
    radius: Float;
    tileTypes: TileType;
    tileCtor: ITileConstructable<RectangularTile | Rectangular8Tile>;
    constructor(scale: Float, orientation?: boolean, shape?: Shape, x?: Integer, y?: Integer, tile?: ITileConstructable<RectangularTile | Rectangular8Tile>);
    bounds(): Rectangle;
